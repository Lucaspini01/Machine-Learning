...
def accuracy(y_true, y_pred):
    ...
    return float(np.sum(y_true == y_pred)) / len(y_true) if len(y_true) > 0 else 0.0
...
def pr_curve_ovr(y_true, y_scores, positive_label=1):
    """
...
def roc_curve_ovr(y_true, y_scores, positive_label=1):
    """
...
def auc_pr_ovr(y_true, y_scores, positive_label=1):
...
def auc_roc_ovr(y_true, y_scores, positive_label=1):
